...
return (
    <section className="mt-10  text-gray-300 body-font">
      <div className="mx-4  container px-5 py-24 shadow-xl bg-gray-700 rounded-lg ">
        <div className="lg:flex  flex-nowrap -mt-4">
          ...
          <div className="w-full">
            <div className="flex w-full justify-center">
              <span className="flex mt-10 w-full mb-4 h-10 items-center md:flex-row max-w-6xl justify-center py-4 bg-gray-500 text-gray-300 text-l font-medium mr-2 px-2.5  rounded dark:bg-gray-700 dark:text-gray-300 border border-gray-300" data-aos="fade-up">
              {title}
              </span>
            </div>
